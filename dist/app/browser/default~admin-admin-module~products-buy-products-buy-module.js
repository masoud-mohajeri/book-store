(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~admin-admin-module~products-buy-products-buy-module"],{

/***/ "O/T3":
/*!****************************************************!*\
  !*** ./src/app/shared/services/package.service.ts ***!
  \****************************************************/
...
/* harmony import */ var _ui_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ui.service */ "8nna");
...
let PackagesService = class PackagesService {
    constructor(bookService, afs, afStorage, uiService) {
        this.bookService = bookService;
        this.afs = afs;
        this.afStorage = afStorage;
        this.uiService = uiService;
        this.packages = [];
        this.packageEmitter = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"](null);
    }
    getAllPackages() {
        return this.afs
            .collection('Packs')
    ...
    updatePackage(thePackage) {
        this.afs
            .doc('Packs/' + thePackage.id)
            .update(thePackage)
            .then(() => {
            this.uiService.presentToast('پک با موفقیت آپدیت شد ');
        })
            .catch((err) => {
            this.uiService.presentToast('در آپدیت پک مشکلی پیش آمد ، لطفا دوباره امتحان کنید ');
            throw new Error(err);
        });
    }
    deletePackage(id) {
        this.afs
            ...
            .catch((err) => {
            this.uiService.presentToast('در حذف پک مشکلی پیش آمد ، لطفا دوباره امتحان کنید ');
            throw new Error(err);
        });
    }
};
PackagesService.ctorParameters = () => [
    { type: _books_service__WEBPACK_IMPORTED_MODULE_5__["BookService"] },
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] },
    { type: _angular_fire_storage__WEBPACK_IMPORTED_MODULE_3__["AngularFireStorage"] },
    { type: _ui_service__WEBPACK_IMPORTED_MODULE_6__["UIService"] }
];
PackagesService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
//# sourceMappingURL=default~admin-admin-module~products-buy-products-buy-module.js.map